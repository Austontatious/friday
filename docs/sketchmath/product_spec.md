...
Last validated SketchMath code milestone: `775df7d` (golden/feature property acceptance, advanced-hole and extrusion extent editing, clean production build, and bounded semantic cut authoring; see `golden_mounting_plate_v1.md` and `status.md`)
