...
This checkpoint is full-circle and hole-only. Partial arcs, 3D axis references, patterns of other feature types, nested pattern execution, feature mirror, shell, and pattern STL/STEP remain open.
