...
| SM-FEAT feature history | Release-train envelope passed; broader full-product feature families remain partial | Extrusion add/cut, full revolve, typed holes, fillet/chamfer, linear/full-circle hole patterns, sketch-line hole mirror, and rectangular top-open shell; deterministic rebuild, guarded editing, recovery/reload, and supported native STEP |
...
| SM-ART artifacts | Release-train envelope passed for supported STL and bounded STEP graphs; overall full-product lifecycle partial | Revision/hash-bound resumable jobs, stale-result refusal, golden eight-feature STEP plus cut/revolve/advanced-hole/edge-finish/shell kernel validation, idempotent registration/reload; automated cleanup and broader full-graph export remain open |
...
| SDD Gate B → feature-history release train | Passed on 2026-08-09 | `b22e27c`; 274 Python tests, 66 semantic cases, 64 frontend tests, 25 live SketchMath workflows, schema/TypeScript/build/Compose/compile/13 standards checks, and native golden plus bounded feature artifacts |
| SM-QA / SM-OPS / SM-SEC hardening | Partial beyond the completed release-train envelope | Final train audit passes 274 Python/runtime tests, 66 semantic cases, 64 frontend tests, 25 live browser workflows, schema/TypeScript/build/Compose/standards; cancellation, TTL/quota, performance, broader instrumentation, and kernel isolation remain open full-product work |
...
| SM-FEAT-001 canonical feature history | Passed for extrusion/hole/full-revolve/linear-and-circular-pattern/hole-mirror/rectangular-shell rebuild envelope | Immutable IDs, explicit dependencies, revision-checked typed operations, deterministic pure rebuild, structured failure, persistence, guarded UI, feature undo/redo | Broader seed/plane/shell families remain open. |
| SM-FEAT-002 extrusion modes | Passed for bounded vertical terminal-solid envelope | Deterministic new-body/add/cut, direction, symmetric and one-/two-sided measurement, semantic attachment/placement/refusal, stable-ID editing, bounded browser top-face cut authoring, validated layered STL, and exact native FreeCAD STEP with undo/redo/job/download/reload | Arbitrary face/body target picking, non-one-sided kernel graphs, cut-before-edge-finish, and general feature-tree execution remain open. |
| SM-FEAT-003 revolve | Passed for independent 360-degree new-body envelope | Explicit stable sketch axis, deterministic Pappus volume/exact bounds, generated semantic faces, stable-ID axis replacement, changed-signature rebuild, undo/redo/reload, structured refusal, and exact native FreeCAD STEP job/download | Partial sweeps, spatial add/cut boolean proof, revolve STL, and multi-feature revolve graphs remain open. |
| SM-FEAT-004 typed holes | Passed for bounded property/rebuild/terminal-STEP envelope | Simple/counterbore/countersink; through/blind validation; containment/depth/reference recovery; all-style editing; stable-ID undo/redo/reload; simple-hole STL; exact native advanced-hole STEP | New advanced-hole creation, advanced-hole STL, arbitrary placement, and advanced-hole-before-edge-finish remain open. |
| SM-FEAT-005 fillet/chamfer/pattern/shell | Partial: fillet/chamfer, linear/full-circle pattern, sketch-line hole mirror, and rectangular top-open shell subsets | Prior edge-finish checkpoints; typed pattern/mirror exact rebuild; shell semantic opening/cavity topology, thickness edit/refusal, guarded UI/reload, and native volume/bounds-validated STEP | Pattern/mirror remain analytic and hole-only; broader/curved shells, partial arcs, 3D axes/planes, pattern/mirror artifacts, arbitrary edges, other graphs, edge-finish/shell STL remain open. |
