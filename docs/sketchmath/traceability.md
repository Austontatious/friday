...
| SM-FEAT-003 revolve | Partial | Explicit stable sketch axis, deterministic full-angle Pappus volume/exact bounds, generated semantic faces, default-off API/UI, stable-ID existing-axis replacement, changed-signature rebuild, undo/redo/reload, persistence, and structured invalid/partial refusal | Browser creates and edits new-body 360-degree revolves only; partial sweeps, spatial add/cut boolean proof, and STL/STEP remain open. |
