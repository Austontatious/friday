...
| SM-FEAT-001 canonical feature history | Passed for extrusion/hole/full-revolve/linear-and-circular-pattern/hole-mirror rebuild envelope | Immutable IDs, explicit dependencies, revision-checked typed operations, deterministic pure rebuild, structured failure, persistence, guarded UI, feature undo/redo | Shell and broader seed/plane families remain open. |
...
| SM-FEAT-005 fillet/chamfer/pattern/shell | Partial: fillet/chamfer plus linear/full-circle pattern and sketch-line mirror hole subsets | Prior edge-finish checkpoints plus `5973c89`/`3e309de`; typed pattern/mirror exact volume/bounds/topology, stable reference/offset identity, overlap/containment/axis refusal, guarded create/edit, undo/redo/reload | Pattern/mirror are analytic and hole-only; partial arcs, 3D axes/planes, shell, feature artifacts, arbitrary edges, other graphs, and edge-finish STL remain open. |
