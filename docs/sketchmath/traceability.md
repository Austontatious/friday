...
| SM-FEAT-002 extrusion modes | Partial | Deterministic new-body/add/cut, direction, symmetric, one-/two-sided measurement, semantic face attachment, physical Z placement, wrong-direction refusal, stable-ID property editing, bounded browser latest-extrusion top-face cut authoring, and validated terminal cut STL with undo/redo/job/download/reload | Arbitrary face/body target picking and general kernel cut STEP execution remain open. |
