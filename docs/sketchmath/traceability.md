...
| SM-FEAT-002 extrusion modes | Partial | Deterministic new-body/add/cut, direction, symmetric, one-/two-sided measurement, semantic face attachment, physical Z placement, wrong-direction refusal, and stable-ID depth/direction/extent/second-depth property editing with undo/redo/reload | Browser creates new/add; cut attachment authoring and general kernel solid execution remain open. |
