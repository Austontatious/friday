...
| SM-QA-002 golden geometry | Passed for base release fixture; edit workflow partial | `5973c89`/`3e309de`; eight-feature spec geometry, analytic pre-fillet ledger, native final volume/bounds/cylinder/fillet checks, recovery, serialization, durable STEP registration/reload | Widened/Ø6 undo-redo browser workflow and post-edit STEP remain open. |
