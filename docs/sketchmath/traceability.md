...
| SM-FEAT-004 typed holes | Passed for documented property/rebuild envelope; artifacts partial | Simple/counterbore/countersink model; through/blind validation; containment/breakout/depth checks; semantic top-face recovery; guarded simple-hole creation plus all-style conditional property editing; stable-ID undo/redo/reload and simple-hole terminal STL | New advanced-hole creation and counterbore/countersink STL/STEP remain outside the bounded artifact envelope. |
