...
| SM-FEAT feature history | `SM-FEAT-001` passed; `SM-FEAT-002/004` partial | `f0c2f49`, `cc08509`, `99e2322`; semantic add/cut placement, typed simple/counterbore/countersink through/blind holes, guarded simple-hole UI, live recovery/reload acceptance |
| SM-REF reference stability | Passed for generated extrusion/hole topology | `987cfd1`, `ee40940`, `99e2322`; stable source/role IDs, geometry signatures, exact/recovered states, atomic missing/ambiguous refusal, attached add/cut/hole tests |
...
| SM-ART artifacts | Passed for default-off supported STL graph envelope; overall partial | `9860570`, `a3d705c`, `0979dfe`; revision/hash-bound resumable jobs, stale-result refusal, terminal graph download, golden bounds/volume/manifold evidence; automated cleanup and full-graph STEP remain open |
...
| SM-FEAT-001 canonical feature history | Passed for extrusion/hole rebuild envelope | Immutable IDs, explicit dependencies, revision-checked typed operations, deterministic pure rebuild, structured failure, persistence, guarded UI, feature undo/redo | Revolve and later feature families remain open. |
...
| SM-ART-001 revisioned artifacts | Passed for supported STL graph envelope | Persistent manifest/step markers, idempotent job ID, revision registration, stale-result refusal, terminal graph UI/download, golden STL | Full-graph STEP, automated retention/cleanup, cancellation, and non-vertical features remain open. |
