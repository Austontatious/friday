...
| SM-FEAT-002 extrusion modes | Partial | Deterministic new-body/add/cut, direction, symmetric, one-/two-sided measurement, semantic face attachment, physical Z placement, wrong-direction refusal, stable-ID property editing, and bounded browser latest-extrusion top-face cut authoring with undo/redo/reload | Arbitrary face/body target picking and general kernel cut solid/artifact execution remain open. |
