...
- The feature-graph worker receives ordered canonical positive base/additive extrusions, simple holes, and bounded negative top-face cut extrusions. Edge-finish graphs additionally carry a typed terminal fillet radius or chamfer distance plus semantic outer-vertical-edge descriptors.
