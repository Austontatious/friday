...
export FRIDAY_SKETCHMATH_HOLE_FEATURES_ENABLED=1
export REACT_APP_SKETCHMATH_HOLE_FEATURES_ENABLED=1
export FRIDAY_SKETCHMATH_FILLET_FEATURES_ENABLED=1
export REACT_APP_SKETCHMATH_FILLET_FEATURES_ENABLED=1
export FRIDAY_SKETCHMATH_CHAMFER_FEATURES_ENABLED=1
export REACT_APP_SKETCHMATH_CHAMFER_FEATURES_ENABLED=1
export FRIDAY_SKETCHMATH_PATTERN_FEATURES_ENABLED=1
export REACT_APP_SKETCHMATH_PATTERN_FEATURES_ENABLED=1
export FRIDAY_SKETCHMATH_MIRROR_FEATURES_ENABLED=1
export REACT_APP_SKETCHMATH_MIRROR_FEATURES_ENABLED=1
export FRIDAY_SKETCHMATH_ARTIFACT_JOBS_ENABLED=1
export REACT_APP_SKETCHMATH_ARTIFACT_JOBS_ENABLED=1
export FRIDAY_SKETCHMATH_SESSION_DIR="$SESSION_DIR"
export FRIDAY_SKETCHMATH_ARTIFACT_JOB_DIR="$SESSION_DIR/jobs"
export FRIDAY_SKETCHMATH_CAD_EXPORT_DIR="$SESSION_DIR/cad"
